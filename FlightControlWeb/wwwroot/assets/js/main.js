...
/**
 * Show on the map all the flights.
 * @param {any} jsons list of flights.
 */
...
/**
 * Get a flight row from the tables.
...
/**
 * Handle the flights that were recieved from the server.
 * @param {any} jsons the flights.
 */
...
/**
 * Request from the server all the active flights. 
 */
...
/**
 * Request a get requesr from the server.
 * @param {any} url the url of the server.
 * @param {any} toDo the call back function.
 */
...
function addFlights(flight) {
    ...
    let table = document.getElementById("external");
...
/**
 * Show the flight plan in the page (path and details).
 * @param {any} flightPlan
 */
...
/**
 * Draw the path of the flight on the map.
 * @param {any} flightPlan the flight plan.
 */
...
/**
 * Remove a flightfrom the page.
 * @param {any} btn the button.
